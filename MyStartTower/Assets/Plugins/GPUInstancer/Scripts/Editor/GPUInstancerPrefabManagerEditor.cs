...
namespace GPUInstancer
{
    ...
    public class GPUInstancerPrefabManagerEditor : GPUInstancerManagerEditor
    {
        ...
        public void SerializeTransforms(GPUInstancerPrefabPrototype prefabPrototype)
        {
            ...
            var basePath = Path.Combine(Path.GetDirectoryName(SceneManager.GetActiveScene().path) ?? string.Empty ,GPUInstancerConstants.PROTOTYPES_SERIALIZED_PATH);
            string assetPath = basePath + prefabPrototype.name + ".asset";
