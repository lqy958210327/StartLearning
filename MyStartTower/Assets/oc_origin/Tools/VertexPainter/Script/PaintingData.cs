...
{
    [HideInInspector] [SerializeField] private Color[] _colors;

    /*[HideInInspector]
    [SerializeField]
    private Vector3[] _positions;*/
    [SerializeField] public MeshVertexColor savedColors;
    ...
    private Mesh ApplyMeshData(Mesh mesh, bool isSkinMesh, bool markNoLongerReadable = false)
    {
